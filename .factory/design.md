...
- Delivery: optimized WebP, explicit dimensions, ≤300 KB. A 1200×630 WebP social card is a center crop of this same original product asset, composed locally with ImageMagick on 2026-09-05; it adds no external imagery. The original PNG and API sidecar are not shipped in the static site.
